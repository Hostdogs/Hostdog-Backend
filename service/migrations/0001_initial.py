# Generated by Django 3.2 on 2021-04-11 14:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('service_status', models.CharField(choices=[('start', 'Start'), ('end', 'End')], max_length=10)),
                ('service_is_over_night', models.BooleanField(default=False)),
                ('service_reg_time', models.DateTimeField(default=datetime.date(2021, 4, 11))),
                ('service_end_time', models.DateTimeField(default=datetime.date(2021, 4, 11))),
